...
import { Bell, CalendarCheck, ChevronDown, FileText, HelpCircle, Home, IndianRupee, LineChart, LogOut, Menu, PiggyBank, Receipt, Search, Settings, Trophy, User, UserPlus, Users, Wallet, X, Sparkles } from 'lucide-react'
