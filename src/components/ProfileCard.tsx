...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, rgba(26,29,27,0.88) 0%, rgba(107,146,216,0.22) 100%)'
  ...
  const cardStyle = useMemo(
    () =>
      ({
        ...
        '--behind-glow-color': behindGlowColor ?? 'rgba(174, 206, 82, 0.45)',
